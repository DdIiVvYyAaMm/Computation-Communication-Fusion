...
.Lfunc_end0:
	...
	.cfi_endproc
                                        # -- End function
	.text
	.globl	_Z15PrintHelloWorldv            # -- Begin function _Z15PrintHelloWorldv
	.p2align	4, 0x90
	.type	_Z15PrintHelloWorldv,@function
_Z15PrintHelloWorldv:                   # @_Z15PrintHelloWorldv
	.cfi_startproc
# %bb.0:
	pushq	%rbp
	.cfi_def_cfa_offset 16
	...
	retq
.Lfunc_end1:
	.size	_Z15PrintHelloWorldv, .Lfunc_end1-_Z15PrintHelloWorldv
	.cfi_endproc
                                        # -- End function
...
# %bb.0:
	...
	movl	%edi, -4(%rbp)
	movq	%rsi, -16(%rbp)
	callq	_Z15PrintHelloWorldv@PLT
	xorl	%eax, %eax
	addq	$16, %rsp
	popq	%rbp
	.cfi_def_cfa %rsp, 8
...
# %bb.0:
	...
	retq
.Lfunc_end3:
	.size	_GLOBAL__sub_I_example.cpp, .Lfunc_end3-_GLOBAL__sub_I_example.cpp
	.cfi_endproc
                                        # -- End function
