...
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @_GLOBAL__sub_I_basic.cu, ptr null }]
...
define dso_local void @_Z30__device_stub__matrixMulKernelPKfS0_Pfiii(ptr noundef %A, ptr noundef %B, ptr noundef %C, i32 noundef %M, i32 noundef %N, i32 noundef %K) #4 {
entry:
  ...
  %call = call noundef i32 @cudaLaunchKernel(ptr noundef @_Z30__device_stub__matrixMulKernelPKfS0_Pfiii, i64 %10, i32 %12, i64 %14, i32 %16, ptr noundef %kernel_args, i64 noundef %7, ptr noundef %8)
  br label %setup.end
...
kcall.configok:                                   ; preds = %for.end25
  ...
  call void @_Z30__device_stub__matrixMulKernelPKfS0_Pfiii(ptr noundef %46, ptr noundef %47, ptr noundef %48, i32 noundef %49, i32 noundef %50, i32 noundef %51) #12
  br label %kcall.end
